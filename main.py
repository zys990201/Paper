...
def main():
    ...
    train_data = Data(train_data, num_node, all_train)
    test_data = Data(test_data, num_node, all_train)

    model = trans_to_cuda(CombineGraph(opt, train_data.adjacency, num_node, dataset=opt.dataset))
